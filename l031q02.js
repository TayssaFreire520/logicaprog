//Elaborar um programa que pergunte o nome do usuário, 
// e quatro valores inteiros e apresente 2 resultados:
...
console.log (`MULTIPLICÃO: ${num1} x ${num2} x ${num3} x ${num4}`);